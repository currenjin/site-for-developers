...
| <img src="https://thebook.io/favicon.ico" height="18" />                                             | [TheBook <sub>KR</sub>](https://thebook.io)                | (주)도서출판 길벗에서 제공하는 IT 도서 열람 서비스                                                                                                                                                             |
...
| <img src="https://www.freecodecamp.org/favicon-32x32.png?v=6cba562cbd10e31af925a976f3db73f7" height="18" /> | [freeCodeCamp <sub>EN,F</sub>](https://www.freecodecamp.org/)                                | 함께 코딩을 배우는 전 세계 사람들의 커뮤니티이자, 다양한 개발 커리큘럼을 제공하는 온라인 무료 학습플랫폼입니다.    |
...
| <img src="https://ssl.pstatic.net/static/m/mooc/p/partner/boostcrs/favicon-32x32.png" height="18" /> | [부스트코스(전 에드위드) <sub>KR</sub>](https://www.boostcourse.org)         | 부스트코스는 네이버(NAVER)와 네이버 커넥트재단(NAVER Connect)이 제공하는 온라인 강좌 플랫폼입니다.                                                   |
...
| <img src="https://learngitbranching.js.org/assets/favicon.ico" height="18" />              | [Learn Git Branching <sub>KR,EN,F</sub>](https://learngitbranching.js.org/) | 시각화된 화면과 함께 튜토리얼과 레벨별 게임을 제공하여 손쉽게 Git을 학습할 수 있는 사이트입니다.                                                                                                   |
...
| 이미지                                                                     | 제목                                                                                | 설명                                                                                                                                                                                                              |
| -------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <img src="https://www.google.com/favicon.ico" height="18" />               | [Google Developers Docs](https://developers.google.com)                             | 구글 개발자 공식 문서                                                                                                                                                                                             |
...
| <img src="https://www.patterns.dev/img/favicon/favicon.ico" height="18" /> | [Patterns.dev <sub>EN</sub>](https://www.patterns.dev/)                             | Vanilla JavaScript 또는 최신 웹 프레임워크를 위한 디자인, 렌더링 및 성능 패턴에 대한 내용을 담고 있습니다.                                                                                                        |
